...
This fork adds `ccs`, a standalone command-line interface for switching CC Switch providers without opening the desktop app. This branch is based on CC Switch 3.20.1 and supports its database schema version 18.
...
- Supports listing and switching providers for Claude, Claude Desktop, Codex, Gemini, Grok Build, OpenCode, OpenClaw, Hermes, and Pi.
